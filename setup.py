...
setup(
    name = "OpenFisca-ACT-Conveyancing",
    version = "3.12.8",
    ...
    description = "OpenFisca demonstration implementation for the ACT applied to conveyancing duties",
    keywords = "benefit microsimulation social tax",
    license = "http://www.fsf.org/licensing/licenses/agpl-3.0.html",
    url = "https://github.com/RamParameswaran/OpenFisca-ACT-Conveyancing",
    include_package_data = True,  # Will read MANIFEST.in
    data_files = [
        (
            "share/openfisca/openfisca-act-conveyancing",
